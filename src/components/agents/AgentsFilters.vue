      ...
      <div class="relative space-y-6">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-400">Encontre agentes rapidamente usando os filtros abaixo</p>
          </div>
        ...
        <!-- Status Filters (se houver) -->
        <div v-if="statusOptions && statusOptions.length">
