    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card padding="md" class="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
        ...
        <div class="relative flex items-center gap-4">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm text-gray-400 mb-1 font-medium">Total de Contatos</p>
      ...
      <Card padding="md" class="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
        ...
        <div class="relative flex items-center gap-4">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm text-gray-400 mb-1 font-medium">Engajados</p>
            <p class="text-3xl font-bold text-white">{{ metrics.engaged || 0 }}</p>
          </div>
        </div>
      </Card>
      ...
      <Card padding="md" class="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
        ...
        <div class="relative flex items-center gap-4">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm text-gray-400 mb-1 font-medium">Convertidos</p>
            <p class="text-3xl font-bold" style="color: var(--color-text1)">{{ metrics.converted || 0 }}</p>
          </div>
        </div>
      </Card>
      ...
      <Card padding="md" class="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
        ...
        <div class="relative flex items-center gap-4">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm text-gray-400 mb-1 font-medium">Taxa de Conversão</p>
            <p class="text-3xl font-bold text-white">{{ metrics.conversionRate || 0 }}%</p>
          </div>
        </div>
      </Card>
    </div>
