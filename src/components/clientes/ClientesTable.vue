            ...
            >
              <td class="px-6 py-4 relative">
                ...
                <div class="flex items-center gap-3">
                  <div class="relative">
                    <div
                      class="absolute -inset-0.5 bg-gradient-to-r from-[#7cba10] to-purple-600 rounded-full blur opacity-0 group-hover:opacity-50 transition duration-300"
                    ></div>
                    <div
              ...
              <td class="px-6 py-4">
                <div class="space-y-1.5">
                  ...
                  <a
                    ...
                    @click.stop
                    class="text-xs text-gray-400 flex items-center gap-1.5 hover:text-[#7cba10] transition-colors w-fit"
                  >
                    <svg
                      class="w-3 h-3"
                      fill="none"
              ...
              <td class="px-6 py-4">
                <span
                  ...
                  :style="{
                    ...
                    border: `1.5px solid ${
                      getStatusConfig(contact.status).color
                    }40`,
                  }"
                >
              ...
              <td class="px-6 py-4">
                <div v-if="contact.agent?.name" class="flex items-center gap-2">
                  <div
                    class="w-8 h-8 rounded-full bg-gradient-to-br from-[#7cba10] to-[#5a8c0d] flex items-center justify-center text-white text-xs font-bold"
                  >
