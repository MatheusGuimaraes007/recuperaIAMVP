...
const { step, nextStep, previousStep, nameknowledgeBase, userknowledgeBase, trainingType, typesOfTraining, productSelected, linksList, write, createKnowledgeBase, statusCreateKnowledgeBase, productCategory, resetState } = useAdminModalBaseConhecimento();
      ...
      <div class="flex-1 p-8 overflow-hidden flex flex-col relative">
        ...
        >
          ...
          <h2 class="text-2xl font-bold text-white mb-3 text-center tracking-tight">
            Criando sua Base {{ nameknowledgeBase }}...
          </h2>
        ...
        >
          ...
          <h2 class="text-2xl font-bold text-white mb-2 text-center tracking-tight">
            Sucesso na Criação da Base de Conhecimento
          </h2>
          <p class="text-gray-400 text-center max-w-sm mb-8 text-sm leading-relaxed">
            Sua base de conhecimento  {{ nameknowledgeBase }} foi criada e já está pronta para uso imediato no sistema.
          </p>
        </div>
        ...
        >
          ...
          <h2 class="text-2xl font-bold text-white mb-2 text-center tracking-tight">
            Erro na Criação da Base de Conhecimento
          </h2>
          <p class="text-gray-400 text-center max-w-sm mb-8 text-sm leading-relaxed">
            Ocorreu um erro ao salvar os dados. Verifique sua conexão e tente novamente. Ou entre em contato com o suporte.
          </p>
        </div>
